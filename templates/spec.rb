require_relative '../solutions/D00'

describe D00 do
  context 'Real data' do
    let(:input_path) { File.join(File.dirname(__FILE__), '../inputs/D00.txt') }
  ...
  context 'Provided examples' do
    ...
    context 'Part 1' do
      it 'Passes the example' do
        expect(subject.part1).to eq 'EXPECTED VALUE'
      end
    end

    context 'Part 2' do
      it 'Passes the example' do
        expect(subject.part2).to eq 'EXPECTED VALUE'
      end
    end
  end
end
